function  Correlation_Calc(datatypes,restlag,tasklag,mask_inputdir,mask_prefix,outputdir,subject_list,subplotyes)
...
%
% For CDB I ran corrthres = -5,0:0.1:0.6 with all subjects and ran 0.7 separately without sub-06.

tic

maskID = mask_prefix;
for corrthres = [-5,0:0.1:0.7] % -5,0:0.1:0.6
    exceldata = [];
    summaryplot = [];
if subplotyes == 1

...
for s in subjects:
    for d in data_types:
        ...
        rapidtide_command = "python C:/Users/s/anaconda3/Scripts/rapidtide" + " " + input_file + " " + output_prefix + " " + \
             "--globalmeaninclude" + " " + GM_mask_file + ":1 " + "--refineinclude" + " " + GM_mask_file + ":1" + " " + "--delaymapping --autosync --datatstep 1.2 --detrendorder 0 --oversampfac 4 --passes 3 --despecklepasses 4 --filterband lfo --searchrange -15 15 --pickleft --nolimitoutput --spatialfilt -1"
